...
function consoleHandleInput()
{
    while (_KernelInputQueue.getSize() > 0)
    {
        ...
        {
            // Check if at prompt. Prevents deletion of prompt
            if(this.CurrentXPosition > 12.49) // width of prompt.
            {
            // Delete previous character.
            var offset = undoDrawOnCanvas(this.CurrentFont, this.CurrentFontSize, this.CurrentXPosition, this.CurrentYPosition);

            // Return cursor back to pervious position.
            this.CurrentXPosition = this.CurrentXPosition - offset;

            // Remove letter from input queue.
            backspaceDetected();
            }
        }
        else
